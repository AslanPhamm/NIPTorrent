...
#SBATCH --output=/mnt/data20tb/NIPT_IONTOR_PHUONGCHAU/NIPTorrent/logs/ref_%j.out
#SBATCH --error=/mnt/data20tb/NIPT_IONTOR_PHUONGCHAU/NIPTorrent/logs/ref_%j.err
#SBATCH --ntasks=1
...
nextflow run main.nf \
    --input_csv /mnt/data20tb/NIPT_IONTOR_PHUONGCHAU/NIPTorrent/ref_sample.csv \
